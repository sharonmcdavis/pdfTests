...
&lt;!DOCTYPE fo:root [
  ...
  <xsl:template match="font">
    ...
    <fo:block><fo:inline font-size="{$size}" font-family="{$face}"
      color="{$color}">
      <xsl:apply-templates select="*|text()"/>
    </fo:inline></fo:block>
  </xsl:template>
  ...
  <xsl:template match="kbd">
    <fo:block><fo:inline font-family="monospace" font-size="110%">
      <xsl:apply-templates select="*|text()"/>
    </fo:inline></fo:block>
  </xsl:template>
  ...
  <xsl:template match="small">
    <fo:block><fo:inline font-size="80%">
      <xsl:apply-templates select="*|text()"/>
    </fo:inline></fo:block>
  </xsl:template>
  ...
  <xsl:template match="strike">
    <fo:block><fo:inline text-decoration="line-through">
      <xsl:apply-templates select="*|text()"/>
    </fo:inline></fo:block>
  </xsl:template>
  ...
  <xsl:template match="sub">
    <fo:block><fo:inline vertical-align="sub" font-size="75%">
      <xsl:apply-templates select="*|text()"/>
    </fo:inline></fo:block>
  </xsl:template>
  ...
  <xsl:template match="sup">
    <fo:block><fo:inline vertical-align="super" font-size="75%">
      <xsl:apply-templates select="*|text()"/>
    </fo:inline></fo:block>
  </xsl:template>
  ...
  <xsl:template match="tt">
    <fo:block><fo:inline font-family="monospace">
      <xsl:apply-templates select="*|text()"/>
    </fo:inline></fo:block>
  </xsl:template>
  ...
  <xsl:template match="u">
    <fo:block><fo:inline text-decoration="underline">
      <xsl:apply-templates select="*|text()"/>
    </fo:inline></fo:block>
  </xsl:template>
