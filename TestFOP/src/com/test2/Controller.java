...
//			rd.forward(request, response);
	...
	private FileOutputStream fopPdf(HttpServletRequest request, HttpServletResponse response) 
        ...
        File responseFile = new File("H:\\git\\pdfTests\\TestFOP\\src\\com\\test2\\response.html");
        try {
...
//            printContent(responseFile);
		...
		StreamSource source = new StreamSource(new File("H:\\git\\pdfTests\\TestFOP\\src\\com\\test2\\response.html"));
